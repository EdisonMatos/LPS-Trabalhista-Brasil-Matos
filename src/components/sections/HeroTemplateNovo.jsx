...
function HeroTemplateNovo({
  ...
  return (
    ...
    >
      <section className="relative w-full pt-[120px] pb-[70px] phone3:pt-[150px] tablet1:pt-[170px] desktop1:pt-[180px] flex items-center justify-center overflow-hidden font-mainFont">
        ...
        <SectionWrapper>
          <div className="container relative z-10 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <div className="flex flex-col gap-4 pt-4 mx-auto desktop1:mx-0">
                <ButtonReflexo
